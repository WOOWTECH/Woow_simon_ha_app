...
class NotificationSensorManager :
    ...
    companion object {
        ...
        val lastNotification = SensorManager.BasicSensor(
            ...
            "mdi:bell-ring",
            docsLink = "https://aiot.simon.io/docs/core/sensors#last-notification",
        ...
        val lastRemovedNotification = SensorManager.BasicSensor(
            ...
            "mdi:bell-ring",
            docsLink = "https://aiot.simon.io/docs/core/sensors#last-removed-notification",
            updateType = SensorManager.BasicSensor.UpdateType.INTENT_ONLY,
        )
        val activeNotificationCount = SensorManager.BasicSensor(
            ...
            docsLink = "https://aiot.simon.io/docs/core/sensors#active-notification-count",
        ...
        private val mediaSession = SensorManager.BasicSensor(
            ...
            "mdi:play-circle",
            deviceClass = "enum",
            docsLink = "https://aiot.simon.io/docs/core/sensors#media-session-sensor",
        )
    }

    override fun docsLink(): String {
        return "https://aiot.simon.io/docs/core/sensors#notification-sensors"
    }
